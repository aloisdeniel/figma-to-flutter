...
import 'package:flutter_figma/src/widgets/remote.dart';
...
class _RemoteFigmaComponentState extends State<RemoteFigmaComponent> {
  ...
  void reloadFigmaLibrary() {
    ...
    _imagesUrls = RemoteFigma.imagesOf(context);
  ...
  DynamicMap _buildTheme() {
    ...
    return {
      ...result,
      if (_imagesUrls != null) 'images': _imagesUrls,
    };
  }
